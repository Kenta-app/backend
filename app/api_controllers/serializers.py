...
def serialize_published_news(
    ...
    *,
    ...
    payload = {
        ...
        "sourceAccount": news.source_account or (news.source.source_account if news.source else None),
        "title": news.title,
        "summary": finish_truncated(repair_english_intrusions(news.summary)),
        "displayText": news.display_text,
        "contentType": news.content_type or "article",
        "contentWarning": news.content_warning,
